...
matrix-scan -m JASPAR_combined_matrices_meme.txt -matrix_format meme -i fetched_seq.fasta -bgfile JASPAR_permuted_matrices_meme.txt -bg_format meme -o matrix_scan_combined

matrix-scan -m JASPAR_combined_matrices_meme.txt -matrix_format meme -i fetched_seq.fasta -bginput -markov 0 -o matrix_scan_combined

matrix-scan -m JASPAR_permuted_matrices_meme.txt -matrix_format meme -i fetched_seq.fasta -bginput -markov 0 -o matrix_scan_permuted
