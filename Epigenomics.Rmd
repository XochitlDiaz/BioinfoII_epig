...
What the web page is actually doing is to run the following command:
...
Sample from a 50 - 55 years old female. Cell-type inflammatory
macrophage and tissue-type venous blood.

\*S001S7

Sample from a 40 - 45 years old female. Cell-type inflammatory
macrophage and tissue-type venous blood.

\*S001MJ

Sample from a 55 - 60 years old male Cell-type inflammatory macrophage
and tissue-type venous blood.
...
enrichment for the histone H3K4m3 in promoter regions as expected.
...
prodeced per biological replicate. These were all submitted to quality
